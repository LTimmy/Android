...
public class shopList extends AppCompatActivity {
    ...
    public void onMessageEvent(MessageEvent event) {
        Toast.makeText(this, event.message1, Toast.LENGTH_SHORT).show();
    }*/
    ...
    public void handleSomethingElse(MessageEvent event) {
       //TextView t = (TextView)findViewById(R.id.initial_1);
       // t.setText(event.message1);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("initial_1",event.message1);
        map.put("name_1",event.message2);
        map.put("price",event.message3);
        mDatas_.add(map);
        adapter.notifyDataSetChanged();
    }
